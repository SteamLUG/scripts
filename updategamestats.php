...
/* we now import functions from steamlug.org repo */
include_once( $includeLocation . '/includes/paths.php' );
include_once( $includeLocation . '/includes/creds.php' );
include_once( $includeLocation . '/includes/functions_steam.php' );
include_once( $includeLocation . '/includes/functions_db.php' );
include_once( $includeLocation . '/includes/functions_apps.php' );
